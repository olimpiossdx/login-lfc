...
import type { HttpClientOptions, HttpMethod, HttpRequestConfig, IApiResponse, RequestInterceptor, ResponseInterceptor } from './types';
    ...
    for (attempt = 1; attempt <= totalAttempts; attempt++) {
      try {
        ...
        apiResponse = {
          ...
          request: {
            url,
            method: finalConfig.method as HttpMethod,
          },
        };
